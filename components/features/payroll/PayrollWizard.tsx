      ...
      {status === "idle" && (
        <div className="text-center py-6">
          <button
            ...
            disabled={isWrongNetwork}
            title={isWrongNetwork ? 'Switch to Testnet in Freighter' : undefined}
            className="w-full sm:w-auto px-6 py-2 rounded-md bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 transition-colors inline-flex justify-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Generate Proof
          </button>
        </div>
...
function ConfirmStep({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-indigo-50/50 border border-indigo-150 rounded-lg p-4 flex items-start gap-3">
        <input
          id="confirm-checkbox"
          type="checkbox"
          checked={confirmed}
        ...
        <div className="text-center py-8 space-y-3">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 mt-4">
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 rounded-md bg-red-50 text-red-700 text-sm font-medium hover:bg-red-100 border border-red-200 transition-colors inline-flex justify-center items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <RotateCcw className="w-3.5 h-3.5" />
              Retry Submission
            </button>
